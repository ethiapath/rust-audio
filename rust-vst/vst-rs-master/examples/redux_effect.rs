...
struct ReduxEffect {
    ...
    params: Arc<ReduxEffectParameters>,
}
...
impl Default for ReduxEffect {
    fn default() -> ReduxEffect {
        ReduxEffect {
            params: Arc::new(ReduxEffectParameters::default()),
        }
    }
}

impl Default for ReduxEffectParameters {
    fn default() -> ReduxEffectParameters {
        ReduxEffectParameters {
...
impl Plugin for ReduxEffect {
    fn get_info(&self) -> Info {
        Info {
            name: "Redux Effect in Rust".to_string(),
...
impl PluginParameters for ReduxEffectParameters {
